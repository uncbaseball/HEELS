...
tags$body(onload = "startup();",
    ...
    tags$div(id = "menu", class = "overlay", 
             ...
             tags$div(class = "overlay-content",
                      ...
                      tags$a(href = paste0("https://micahdh.github.io/Hitters/", params$batter, ".html"), "Home"),
                      tags$a(href = paste0("https://micahdh.github.io/Hitters/2019/", params$batter, ".html"), "This Season Only"),
                      tags$a(href = paste0("https://micahdh.github.io/Hitters/", params$batter, " Video Dropdown.html"), "Video"),
                      tags$a(href = "https://micahdh.github.io/Hitters/Advanced_Scouting/regionals.html", "Opponent Video")
                      )),
...
# ),
  ...
  tags$footer(
    tags$select(id = "newvisual", 
                ...
                tags$option("Location", value = 1),
                tags$option("Spraychart", value = 2), 
                tags$option("Angle/Exit Velo", value = 3),
                tags$option("Video", value = 4),
                tags$option("HR/BB/K/Hard Hit", value = 5),
                tags$option("AVG/OBP/SLG", value = 6),
                tags$option("Contact Quality", value = 7),
                tags$option("Contact Type"), value = 8),
    tags$button(onclick = "changevisual();", "Go")
  )
